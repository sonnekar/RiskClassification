...
# Step 1: Load your DataFrame and generate embeddings
...
y = torch.tensor(danger_magnitudes, dtype=torch.float32)  # Change dtype if needed (e.g., long for classification)
...
# Step 3: Define the Neural Network with corrected residual connection
...
model.eval()
with torch.no_grad():
    y_val_pred = model(X_val).squeeze()  # Get predictions for X_val
